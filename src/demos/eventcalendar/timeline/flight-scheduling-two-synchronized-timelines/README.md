...
- Use `renderResource` (Angular: `resourceTemplate`, Vue: `#resource` slot) on the bottom calendar to show a jet photo, name, tail code, and crew count for leaf nodes, and just the operator name for group nodes.
