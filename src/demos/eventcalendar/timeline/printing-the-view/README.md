...
- Calling `inst.print()` extracts the calendar markup into a temporary page and invokes the browser's print function — only the timeline is printed, not the surrounding page.
