...
- Get a reference to the component instance (Angular: use `@ViewChild` to get the `MbscEventcalendar` reference). Calling `inst.print()` extracts the calendar markup into a temporary page and invokes the browser print dialog.
