...
- Calling `inst.print()` extracts the calendar markup into a temporary page and calls the browser's print function — only the calendar is printed, not the surrounding page.
